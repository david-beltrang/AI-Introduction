...
- **El motor prioriza terminación sobre completitud garantizada.** Los límites de 15 iteraciones y 800 cláusulas, junto con la poda de pares donde ambas cláusulas tienen más de 3 literales, pueden causar **falsos negativos**: el motor puede reportar "no demostrado" para consecuencias lógicas que SÍ son válidas pero cuya demostración requiere más recursos o combinar cláusulas grandes. La resolución en LPO es semidecidible — no existe cota superior teórica — por lo que estos cortes son necesarios para uso interactivo, pero implican que el motor **no es completo**.
